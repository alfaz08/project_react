    ...
    <div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        <div className=''>
         ...
         <h2 className='text-center mb-2 mt-2 text-sm font-bold text-gray-500 '>Webbuilder 1</h2>
        <h2 className='mb-1'>Computer Modern clasic with wix support</h2>
        ...
        <button className='bg-blue-500 mt-4 mb-2 text-white w-full h-12 rounded-l-2xl rounded-r-2xl'>View Deal</button>
        </div>
